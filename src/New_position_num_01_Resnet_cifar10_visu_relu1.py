...
g = os.walk(r'/home/ipp-9236/PYZhu/ICIP23/Resnet18_cifar10/baseEntropyExpoMagni_prun/ReInitialize/model') 
layer_out_num = []
...
for root, dir_list, file_list in g:
	for file_name in file_list:
		...
		target_model= torch.load('/home/ipp-9236/PYZhu/ICIP23/Resnet18_cifar10/baseEntropyExpoMagni_prun/ReInitialize/model/'+file_name).to(device)          #load the models
		...
		np.savez('/home/ipp-9236/PYZhu/ICIP23/Resnet18_cifar10/baseEntropyExpoMagni_prun/ReInitialize/para_per_num/para_position_01/' +'entropy_num_per'+file_name ,                 
					layer_name=layer_name, layer_act_0_per=layer_act_0_per, layer_act_1_per = layer_act_1_per, 
					layer_act_0_num = layer_act_0_num, layer_act_1_num=layer_act_1_num,layer_act_mix_num=layer_act_mix_num,entorpy0_position=entorpy0_position)
		...
		plt.savefig('/home/ipp-9236/PYZhu/ICIP23/Resnet18_cifar10/baseEntropyExpoMagni_prun/ReInitialize/para_per_num/fig/' +'entro_per_num'+file_name  + '.pdf')            # save the bar plots for resnet model
