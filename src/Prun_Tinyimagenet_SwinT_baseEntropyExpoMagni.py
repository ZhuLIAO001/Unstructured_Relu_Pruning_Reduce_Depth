...
# Hyper-parameters
project_name = "ICIP_SwinT_TinyIma_baseEntropyExpoMagni_prun_" 
...
model.head = torch.nn.Linear(in_features=model.head.in_features, out_features=200)
model.to(device)
...
for epoch in range(1,epochs+1):
	...
	torch.save(temp_model, '/home/ids/ipp-9236/PYZhu/ICIP23/SwinT_TinyImagi/baseEntropyExpoMagni_prun/model/'+ name_model)
...
for i in range(1, 10):
	...
	for epoch in range(1,epochs+1):
		...
		torch.save(model, '/home/ids/ipp-9236/PYZhu/ICIP23/SwinT_TinyImagi/baseEntropyExpoMagni_prun/model/'+'check_point_'+ name_model)
	...
	plt.savefig('/home/ids/ipp-9236/PYZhu/ICIP23/SwinT_TinyImagi/baseEntropyExpoMagni_prun/Tradeoff_curve/'+' sparsity_acc_Tradeoff_curve_'+str(sparsity) + '.png')
	# plt.show()
